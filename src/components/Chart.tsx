...
import { TempHumChart } from './ui/TempHumChart'
import { AtmoPresChart } from './ui/AtmoPresChart'
    ...
    return (
        <main className='h-full w-full'>
            ...
            <div className='h-full w-full flex justify-center items-center'>
                <div className='h-3/4 w-4/5 md:w-3/5 flex flex-col md:flex-row justify-between items-center md:space-x-5'>
